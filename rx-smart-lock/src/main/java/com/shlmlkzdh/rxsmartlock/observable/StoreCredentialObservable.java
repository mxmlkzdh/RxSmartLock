...
public class StoreCredentialObservable implements Observable.OnSubscribe<Boolean> {

    private Context mContext;
    private Credential mCredential;

    public StoreCredentialObservable(Context context, Credential credential) {
        mContext = context;
    ...
    private class GoogleApiClientCallbacks implements GoogleApiClient.ConnectionCallbacks,
        ...
        public void onConnected(Bundle bundle) {
            ...
            try {
                Auth.CredentialsApi.save(mGoogleApiClient, mCredential).setResultCallback(this);
            } catch (Exception e) {
                mObserver.onError(e);
            }
        ...
        private void onCredentialStored() {
